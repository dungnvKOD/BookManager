...
class SachRecyclerItemTouchHelper(dragDirs: Int,
                                  swipeDirs: Int,
    ...
    override fun onSelectedChanged(viewHolder: RecyclerView.ViewHolder?,
        ...
        if (viewHolder != null) {
            val foregroundView = (viewHolder as BookAdapter.ViewHolder).viewForegroundBookType
    ...
    override fun clearView(recyclerView: RecyclerView,
        ...
        val foregroundView: View = (viewHolder as BookAdapter.ViewHolder).viewForegroundBookType
